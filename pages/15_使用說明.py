...
FEATURES = [
    ...
    ("📰", "新聞分析（頁5）", "News Intel", CYAN,
     "六個分頁：信心分數、新聞情緒、法人報告、<b>產業趨勢雷達</b>（新聞熱度×RRG，🔥=轉熱+資金改善）、"
     "<b>文章解讀</b>（貼網址→個股多空情報卡）、<b>個股筆記</b>（財報觀察筆記產生器）。",
     "文章解讀貼優分析等網址即可；個股筆記把法說數字貼進補充欄，推論會更扎實。"),
